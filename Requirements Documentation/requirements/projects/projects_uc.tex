...
\centerline{\fbox{\includegraphics[scale=0.6]{CRUD/uprm_createTimeline.png}}}	
...
\centerline{\fbox{\includegraphics[scale=0.5]{CRUD/uprm_updateTimeline.png}}}
...
\centerline{\fbox{\includegraphics[scale=0.5]{CRUD/uprm_delete.png}}}